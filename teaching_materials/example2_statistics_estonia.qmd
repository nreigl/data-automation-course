...
format:
  revealjs:
    ...
    encoding: "UTF-8"
    footer: "[GitHub - Example 2](https://github.com/nreigl/data-automation-course/blob/main/teaching_materials/example2_statistics_estonia.qmd)"
    incremental: true
    preview-links: true
    scroll-view: false
    theme: simple
...
-   [Statistics Estonia](https://www.stat.ee/en) uses the **PX-WEB API** (not SDMX)
...
-   PX-WEB API is also used by many Nordic statistical agencies (Sweden, Finland, Norway)
